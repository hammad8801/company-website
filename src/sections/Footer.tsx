...
export function Footer() {
  return (
    <footer className="relative border-t border-white/5 px-6 md:px-10 pt-20 pb-10 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <motion.div
          ...
          className="font-display leading-[0.85] tracking-tighter text-white/95 select-none"
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8 md:gap-10 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-white/60">+91 00000 00000</li>
              <li className="text-white/60">India</li>
            </ul>
          </div>
        </div>

        <div className="mt-14 flex flex-wrap items-center justify-between gap-4 text-xs text-white/40 border-t border-white/10 pt-8">
